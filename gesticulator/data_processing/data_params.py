...
dataset_argparser.add_argument('--raw_data_dir', '-data_raw', default="/data/dataset_trinity/raw_data/",
                help='Path to the folder with the raw dataset')
dataset_argparser.add_argument('--proc_data_dir', '-data_proc', default="/data/dataset_trinity/processed_data",
...
# Sequence processing
processing_argparser.add_argument('--seq_len', '-seq_l', default=40, type=int,
