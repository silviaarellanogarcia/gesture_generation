...
from gesticulator.model.diffusion.losses import normal_kl, discretized_gaussian_log_likelihood

from gesticulator.model.diffusion.nn import mean_flat, sum_flat
# from diffusion.nn import mean_flat, sum_flat
# from diffusion.losses import normal_kl, discretized_gaussian_log_likelihood
# from data_loaders.humanml.scripts import motion_process

def get_named_beta_schedule(schedule_name, num_diffusion_timesteps, scale_betas=1.): ## Same
    """
...
class LossType(enum.Enum): ## Same
    ## Returns the type of loss used, but it doesn't compute anything
